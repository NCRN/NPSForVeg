...
#'  
#' @details This function is a wrapper for \code{getPlots()$Plot_Name}.  It first calls \code{getPlots} and then extracts the \code{Plot_Name} field. It is meant as a convenience function.
#'  
#' @export
