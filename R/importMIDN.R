...
#' .csv files are: Plots, Events, Cycles, Trees, Saplings, Seedlings, Vines, Herbs, CWD and CommonNames.
#'
...
importMIDN<-function(Dir){
  ...
  APCO<-new("NPSForVeg",
            ...
            VPlotSize=c(1,20*20),
            HPlotSize=c(12,1),
            Cycles=InCycles[InCycles$Unit_Code=="APCO",],
  ...
  ASIS<-new("NPSForVeg",
            ParkCode="ASIS",
            ShortName="Assateague Island",
            LongName="Assateague Island National Seashore",
            Network='NCBN',
            TPlotSize=c(1,20*20),
            SapPlotSize=c(3,pi*3*3),
            SeedPlotSize=c(12,1),
            ...
            VPlotSize=c(1,20*20),
            HPlotSize=c(12,1),
            Cycles=InCycles[InCycles$Unit_Code=="ASIS",],
            Plots=InPlots[InPlots$Unit_Code=="ASIS",],
            Events=InEvents[InEvents$Unit_Code=="ASIS",],
            Trees=InTrees[InTrees$Unit_Code=="ASIS",],
            Saplings=InSaps[InSaps$Unit_Code=="ASIS",],
            Seedlings=InSeeds[InSeeds$Unit_Code=="ASIS",],
            #Shrubs=InShrubs[InShrubs$Unit_Code=="ASIS",],
            #ShSeedlings=InShSeeds[InShSeeds$ Unit_Code=="ASIS",],
            Vines=InVines[InVines$Unit_Code=="ASIS",],
            Herbs=InHerbs[InHerbs$Unit_Code=="ASIS",],
            CWD=InCWD[InCWD$Unit_Code=="ASIS",],
            Commons=InCommons)
  ...
  BOWA<-new("NPSForVeg",
            ...
            VPlotSize=c(1,20*20),
            HPlotSize=c(12,1),
            Cycles=InCycles[InCycles$Unit_Code=="BOWA",],
  ...
  COLO<-new("NPSForVeg",
            ...
            VPlotSize=c(1,20*20),
            HPlotSize=c(12,1),
            Cycles=InCycles[InCycles$Unit_Code=="COLO",],
  ...
  FRSP<-new("NPSForVeg",
            ...
            VPlotSize=c(1,20*20),
            HPlotSize=c(12,1),
            Cycles=InCycles[InCycles$Unit_Code=="FRSP",],
  ...
  GETT<-new("NPSForVeg",
            ...
            VPlotSize=c(1,20*20),
            HPlotSize=c(12,1),
            Cycles=InCycles[InCycles$Unit_Code=="GETT",],
  ...
  GEWA<-new("NPSForVeg",
            ...
            VPlotSize=c(1,20*20),
            HPlotSize=c(12,1),
            Cycles=InCycles[InCycles$Unit_Code=="GEWA",],
  ...
  HOFU<-new("NPSForVeg",
            ...
            VPlotSize=c(1,20*20),
            HPlotSize=c(12,1),
            Cycles=InCycles[InCycles$Unit_Code=="HOFU",],
  ...
  PETE<-new("NPSForVeg",
            ...
            VPlotSize=c(1,20*20),
            HPlotSize=c(12,1),
            Cycles=InCycles[InCycles$Unit_Code=="PETE",],
  ...
  RICH<-new("NPSForVeg",
            ...
            VPlotSize=c(1,20*20),
            HPlotSize=c(12,1),
            Cycles=InCycles[InCycles$Unit_Code=="RICH",],
  ...
  SAHI<-new("NPSForVeg",
            ...
            VPlotSize=c(1,20*20),
            HPlotSize=c(12,1),
            Cycles=InCycles[InCycles$Unit_Code=="SAHI",],
  ...
  THST<-new("NPSForVeg",
            ...
            VPlotSize=c(1,20*20),
            HPlotSize=c(12,1),
            Cycles=InCycles[InCycles$Unit_Code=="THST",],
  ...
  VAFO<-new("NPSForVeg",
            ...
            VPlotSize=c(1,20*20),
            HPlotSize=c(12,1),
            Cycles=InCycles[InCycles$Unit_Code=="VAFO",],
  ...
  return(c(APCO,ASIS,BOWA,COLO,FRSP,GETT,GEWA,HOFU,PETE,RICH,SAHI,THST,VAFO))
}
